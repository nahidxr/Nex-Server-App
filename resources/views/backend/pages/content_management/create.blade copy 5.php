...
<script>
    ...
    document.getElementById('addProfileButton').addEventListener('click', function () {
        ...
        // Add the new profile details to the container
        const profileContainer = document.getElementById('profileContainer');
        profileContainer.insertAdjacentHTML('beforeend', profileDetailsHtml);

        // Show the new profile details
        const newProfileDetails = document.getElementById(`profileDetails${profileCount}`);
        newProfileDetails.classList.add('show');
    });

    document.getElementById('addCustomProfileButton').addEventListener('click', function () {
        // Show custom profile inputs
        profileCount++;
        const customProfileDetails = `
            <div id="customProfileDetails${profileCount}" class="collapse mt-3">
                <div class="row">
                    <div class="col">
                        <label for="customScaleX">Scale X</label>
                        <input type="number" class="form-control" name="profiles[${profileCount}][custom_scale_x]" placeholder="Enter Custom Scale X" required>
                    </div>
                    <div class="col">
                        <label for="customScaleY">Scale Y</label>
                        <input type="number" class="form-control" name="profiles[${profileCount}][custom_scale_y]" placeholder="Enter Custom Scale Y" required>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col">
                        <label for="customHeight">Height</label>
                        <input type="number" class="form-control" name="profiles[${profileCount}][custom_height]" placeholder="Enter Custom Height" required>
                    </div>
                    <div class="col">
                        <label for="customWidth">Width</label>
                        <input type="number" class="form-control" name="profiles[${profileCount}][custom_width]" placeholder="Enter Custom Width" required>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col">
                        <label for="customAudioBitrate">Audio Bitrate (Kb)</label>
                        <input type="number" class="form-control" name="profiles[${profileCount}][custom_audio_bitrate]" placeholder="Enter Custom Audio Bitrate" required>
                    </div>
                    <div class="col">
                        <label for="customVideoBitrate">Video Bitrate (Kb)</label>
                        <input type="number" class="form-control" name="profiles[${profileCount}][custom_video_bitrate]" placeholder="Enter Custom Video Bitrate" required>
                    </div>
                </div>
            </div>
        `;
        const profileContainer = document.getElementById('profileContainer');
        profileContainer.insertAdjacentHTML('beforeend', customProfileDetails);
        const newCustomProfileDetails = document.getElementById(`customProfileDetails${profileCount}`);
        newCustomProfileDetails.classList.add('show');
    });
</script>
